...
async function main() {
  ...
  const testLeadPatterns = [
    ...
    { title: { contains: "Prod Test", mode: "insensitive" as const } },
    { title: { contains: "Final Prod Check", mode: "insensitive" as const } },
    { title: { contains: "Post-env-deploy test", mode: "insensitive" as const } },
    { title: { contains: "QA Test", mode: "insensitive" as const } },
    { title: { contains: "DROP TABLE", mode: "insensitive" as const } },
    { title: { contains: "<script>", mode: "insensitive" as const } },
    ...(includeSystem
