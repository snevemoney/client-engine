...
const projects = [
  ...
  {
    slug: "emmanuelle-vandepitterie-backstage-bankable",
    name: "Emmanuelle Vandepitterie",
    description:
      "Lead prospect — business coaching platform exploration. Never built; archived.",
    repoUrl: null,
    techStack: [],
    status: "archived",
    screenshots: [],
