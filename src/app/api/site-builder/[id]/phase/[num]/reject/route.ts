/**
 * POST /api/site-builder/[id]/phase/[num]/reject
 *
 * Reject a completed phase. Stores operatorNotes for regeneration context.
 */
...
export async function POST(
  ...
  return withRouteTiming("POST /api/site-builder/[id]/phase/[num]/reject", async () => {
    ...
    if (phase.status !== "complete") {
      return jsonError(`Phase ${phaseNum} must be complete to reject (current: ${phase.status})`, 400, "INVALID_STATE");
    }
