...
/** POST /api/intake-leads/[id]/followup-log-call */
export async function POST(
  req: NextRequest,
  { params }: { params: Promise<{ id: string }> }
) {
  return withRouteTiming("POST /api/intake-leads/[id]/followup-log-call", async () => {
    ...
    const content = `Call (${body.outcome})${notePart}`;
