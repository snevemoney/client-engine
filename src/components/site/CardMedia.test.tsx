...
describe("CardMedia", () => {
  ...
  it("renders a muted looping preview with mp4 then webm sources", () => {
    ...
    expect(sources[0]?.getAttribute("src")).toBe("/screenshots/sketchbook/preview.mp4?v=4");
    expect(sources[1]?.getAttribute("src")).toBe("/screenshots/sketchbook/preview.webm?v=4");
