 ...
 * (or same path with .jpg) except on fill cards — iOS often leaves
 * the poster up and it reads as a still. Missing files fall back
 * only when the element has no source (NETWORK_NO_SOURCE).
 */
export function CardMedia({
  ...
  return (
    <video
      ref={videoRef}
      poster={!fill && poster ? rootPublicSrc(poster) : undefined}
      muted
      loop
      playsInline
      autoPlay
