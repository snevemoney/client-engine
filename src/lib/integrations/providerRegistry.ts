...
export const PROVIDER_REGISTRY: ProviderDef[] = [
  { provider: "meta", displayName: "Meta Ads", category: "analytics", prodOnly: true, defaultMode: "off", helpText: "LIVE runs only in production. Use MOCK or MANUAL in local.", supportsLive: true, supportsMock: true, supportsManual: true, sortOrder: 10, hasRealTest: true },
  ...
  { provider: "rss", displayName: "RSS / News", category: "research", prodOnly: false, defaultMode: "mock", helpText: "Add feed URLs. Query params for filtering stored in config.", supportsLive: true, supportsMock: true, supportsManual: true, sortOrder: 30, supportsQueryParams: true },
  { provider: "linkedin", displayName: "LinkedIn", category: "outreach", prodOnly: true, defaultMode: "manual", helpText: "LIVE runs only in production. Use MOCK or MANUAL in local.", supportsLive: true, supportsMock: true, supportsManual: true, sortOrder: 40 },
  ...
  { provider: "ga4", displayName: "Google Analytics 4", category: "analytics", prodOnly: true, defaultMode: "off", helpText: "LIVE runs only in production. Use MOCK or MANUAL in local.", supportsLive: true, supportsMock: true, supportsManual: true, sortOrder: 80 },
  { provider: "search_console", displayName: "Google Search Console", category: "visibility", prodOnly: true, defaultMode: "manual", helpText: "LIVE runs only in production.", supportsLive: true, supportsMock: true, supportsManual: true, sortOrder: 90 },
  ...
  { provider: "google_business_profile", displayName: "Google Business Profile", category: "visibility", prodOnly: true, defaultMode: "manual", helpText: "LIVE runs only in production.", supportsLive: true, supportsMock: true, supportsManual: true, sortOrder: 120 },
  ...
  { provider: "google-ads", displayName: "Google Ads", category: "analytics", prodOnly: true, defaultMode: "off", helpText: "LIVE runs only in production.", supportsLive: true, supportsMock: true, supportsManual: true, sortOrder: 150 },
